...
<head>
    ...
    <title>Kartu Keluarga - Rukun Warga 09</title>
        ...
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0" style="background: #fcf2dd;">
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
                ...
                <ul class="navbar-nav" id="accordionSidebar">
                    ...
                    <li class="nav-item"><a class="nav-link active link-dark" href="kartu_keluarga.php"><i class="far fa-id-card text-dark"></i><span>Kartu Keluarga</span></a></li>
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <div class="container-fluid">
                    <h3 class="text-dark mb-4">Kartu Keluarga</h3>
                                    <?php
                                    if(isset($_SESSION['kk_error'])) {
                                        echo $_SESSION['kk_error'];
                                        unset($_SESSION['kk_error']);
                                    }
                                    ?>
                    <div class="card shadow">
                        <div class="card-header py-3">
                            <div class="row">
                                <div class="col">
                                    <p class="text-dark m-0 fw-bold" style="color: rgb(252,242,221);">Data Kartu Keluarga</p>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                                <div class="row">
                                    <div class="col"><button class="btn btn-primary link-dark" type="button" style="background: rgb(252,242,221);border-color: rgb(252,242,221);" data-bs-toggle="modal" data-bs-target="#modalTambah"><i class="fas fa-plus"></i>&nbsp;Tambah Kartu Keluarga</button>
                                        <div class="modal fade" role="dialog" tabindex="-1" id="modalTambah">
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                <form method="post" action="action.php">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title text-dark">Tambah Kartu Keluarga</h5><button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                    </div>
                                                    <div class="modal-body">
                                                            <label class="form-label text-dark">No Kartu Keluarga :</label>
                                                            <input class="form-control" type="text" placeholder="No Kartu Keluarga" required="" name="no_kartu_keluarga" minlength="0" maxlength="16" pattern="^\d{16}$">
                                                            <label class="form-label text-dark mt-3">Nama Kepala Keluarga :</label>
                                                            <input class="form-control" type="text" name="nama_kepala_keluarga" placeholder="Nama Kepala Keluarga" required="">
                                                            ...
                                                            <input class="form-control" type="text" name="desa_kelurahan" placeholder="Desa / Kelurahan" required="">
                                                            ...
                                                            <input class="form-control" type="text" name="kabupaten_kota" placeholder="Kabupaten / Kota" required="">
                                                    ...
                                                    <div class="modal-footer">
                                                        <button class="btn btn-light" type="reset">
                                                            ...
                                                            <button class="btn btn-success link-light" name="tambah_kk" type="submit"><i class="fas fa-save"></i>&nbsp;Save</button>
                                                        </div>
                                                </form>
                                                </div>
                                            </div>
                            ...
                            <div class="table-responsive table mt-2 text-center" id="dataTable" role="grid" aria-describedby="dataTable_info">
                                <table class="table my-0" id="dataTable">
                                    ...
                                    <tbody>
                                        ...
                                        $cari = $_POST['cari'];
                                        $query_kk = mysqli_query($koneksi, "select * from kartu_keluarga WHERE no_kartu_keluarga LIKE '%$cari%' OR
                                                                                                                nama_kepala_keluarga LIKE '%$cari%' OR
                                                                                                                alamat LIKE '%$cari%' OR
                                                                                                                rt LIKE '%$cari%' OR
                                        ...
                                        $query_kk = mysqli_query($koneksi, "select * from kartu_keluarga");
                                        }
                                        while($result = mysqli_fetch_assoc($query_kk)){
                                        $no_kartu_keluarga = $result['no_kartu_keluarga'];
                                        ...
                                        ?>
                                        <tr>
                                            <td><?php echo $no_kartu_keluarga ?></td>
                                            <td><?php echo $nama_kepala_keluarga ?></td>
                                            <td><?php echo $alamat ?></td>
                                            <td><?php echo $rt ?></td>
                                            <td><?php echo $desa_kelurahan ?></td>
                                            <td><?php echo $kecamatan ?></td>
                                            <td><?php echo $kabupaten_kota ?></td>
                                            <td><?php echo $provinsi ?></td>
                                            <td>
                                                <p><button class="btn btn-warning btn-sm" type="button" data-bs-toggle="modal" data-bs-target="#modalEdit<?php echo $no_kartu_keluarga ?>"><i class="far fa-edit"></i></button>&nbsp;&nbsp;<button class="btn btn-danger btn-sm" type="button" data-bs-toggle="modal" data-bs-target="#modalHapus<?php echo $no_kartu_keluarga ?>"><i class="fas fa-trash-alt"></i></button></p>
                                                <div class="modal fade text-start" role="dialog" tabindex="-1" id="modalEdit<?php echo $no_kartu_keluarga ?>">
                                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title text-dark">Edit Kartu Keluarga</h5><button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                            </div>
                                                            <form method="post" action="action.php">
                                                            <div class="modal-body">
                                                                    <label class="form-label text-dark">No Kartu Keluarga :</label>
                                                                    <input class="form-control" type="text" placeholder="No Kartu Keluarga" required="" name="no_kartu_keluarga" minlength="0" maxlength="16" pattern="^\d{16}$" value="<?php echo $no_kartu_keluarga ?>">
                                                                    <label class="form-label text-dark mt-3">Nama Kepala Keluarga :</label>
                                                                    <input class="form-control" type="text" placeholder="Nama Kepala Keluarga" name="nama_kepala_keluarga" value="<?php echo $nama_kepala_keluarga ?>" required="">
                                                                    <label class="form-label text-dark mt-3">Alamat :</label>
                                                            ...
                                                            <div class="modal-footer">
                                                                <button class="btn btn-light" type="reset"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="1em" height="1em" fill="currentColor">
                                                                        <!--! Font Awesome Free 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free (Icons: CC BY 4.0, Fonts: SIL OFL 1.1, Code: MIT License) Copyright 2022 Fonticons, Inc. -->
                                                                        <path d="M480 256c0 123.4-100.5 223.9-223.9 223.9c-48.84 0-95.17-15.58-134.2-44.86c-14.12-10.59-16.97-30.66-6.375-44.81c10.59-14.12 30.62-16.94 44.81-6.375c27.84 20.91 61 31.94 95.88 31.94C344.3 415.8 416 344.1 416 256s-71.69-159.8-159.8-159.8c-37.46 0-73.09 13.49-101.3 36.64l45.12 45.14c17.01 17.02 4.955 46.1-19.1 46.1H35.17C24.58 224.1 16 215.5 16 204.9V59.04c0-24.04 29.07-36.08 46.07-19.07l47.6 47.63C149.9 52.71 201.5 32.11 256.1 32.11C379.5 32.11 480 132.6 480 256z"></path>
                                                                    </svg>&nbsp;Reset</button><button class="btn btn-warning link-dark" name="update_kk" type="submit"><i class="fas fa-save"></i>&nbsp;Update</button>
                                                                </div></form>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="modal fade" role="dialog" tabindex="-1" id="modalHapus<?php echo $no_kartu_keluarga ?>">
                                                    <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer"><button class="btn btn-light" type="button" data-bs-dismiss="modal">Close</button>
                                                                <form method="post" action="action.php"><input type="text" name="id" value="<?php echo $no_kartu_keluarga ?>" hidden><button class="btn btn-danger" name="hapus_kk" type="submit">Yes, Delete</button></form>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
